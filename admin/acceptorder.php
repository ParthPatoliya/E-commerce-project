  ...
  <div class="content">
    ...
    $selectSalesOrder = "SELECT * FROM sales_order NATURAL JOIN retailer WHERE sales_order.Retailer_idRetailer=retailer.idRetailer AND is_cancel=0 ORDER BY idSales_Order DESC";
