...
//  echo "--------------------------------hii";
    include 'backend/db_connect.php';
         ...
         //  echo "updating...";
           ...
           $sql="UPDATE `admin` SET `company_name`='$cname',`company_address`='$address',`gst`='$gst',`phone`='$phone',`email`='$email' , `password`='$password'  where `id`= $id";
                ...
                <form class="form-horizontal" method ="post">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputEmail" value="<?php echo $row['email'];  ?>" name="email">
                    </div>
                  </div>
