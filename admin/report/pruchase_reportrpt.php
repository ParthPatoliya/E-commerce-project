...
// Create page object
if (!isset($pruchase_report_rpt))
	$pruchase_report_rpt = new pruchase_report_rpt();
if (isset($Page))
	$OldPage = $Page;
$Page = &$pruchase_report_rpt;
...
// Form object
var fpruchase_reportrpt = currentForm = new ew.Form("fpruchase_reportrpt");

// Use Ajax
fpruchase_reportrpt.lists["x_date"] = <?php echo $pruchase_report_rpt->date->Lookup->toClientList() ?>;
fpruchase_reportrpt.lists["x_date"].popupValues = <?php echo json_encode($pruchase_report_rpt->date->SelectionList) ?>;
fpruchase_reportrpt.lists["x_date"].popupOptions = <?php echo JsonEncode($pruchase_report_rpt->date->popupOptions()) ?>;
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
...
<div id="ew-center" class="<?php echo $pruchase_report_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php
	...
	$Page->renderRow();
?>
<form name="fpruchase_reportrpt" id="fpruchase_reportrpt" class="form-inline ew-form ew-ext-filter-form" action="<?php echo CurrentPageName() ?>">
<?php $searchPanelClass = ($Page->Filter <> "") ? " show" : " show"; ?>
</form>
<script>
fpruchase_reportrpt.filterList = <?php echo $Page->getFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_pruchase_report" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="idProduct_Master"><div class="pruchase_report_idProduct_Master"><span class="ew-table-header-caption"><?php echo $Page->idProduct_Master->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="idProduct_Master">
<?php if ($Page->sortUrl($Page->idProduct_Master) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_idProduct_Master">
			<span class="ew-table-header-caption"><?php echo $Page->idProduct_Master->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_idProduct_Master" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->idProduct_Master) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->idProduct_Master->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Name"><div class="pruchase_report_Product_Name"><span class="ew-table-header-caption"><?php echo $Page->Product_Name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Name">
<?php if ($Page->sortUrl($Page->Product_Name) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Name">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Name) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Details"><div class="pruchase_report_Product_Details"><span class="ew-table-header-caption"><?php echo $Page->Product_Details->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Details">
<?php if ($Page->sortUrl($Page->Product_Details) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Details">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Details->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Details" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Details) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Details->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Price"><div class="pruchase_report_Product_Price"><span class="ew-table-header-caption"><?php echo $Page->Product_Price->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Price">
<?php if ($Page->sortUrl($Page->Product_Price) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Price">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Price->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Price" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Price) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Price->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Size"><div class="pruchase_report_Product_Size"><span class="ew-table-header-caption"><?php echo $Page->Product_Size->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Size">
<?php if ($Page->sortUrl($Page->Product_Size) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Size">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Size->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Size" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Size) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Size->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Qty"><div class="pruchase_report_Product_Qty"><span class="ew-table-header-caption"><?php echo $Page->Product_Qty->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Qty">
<?php if ($Page->sortUrl($Page->Product_Qty) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Qty">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Qty->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Qty" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Qty) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Qty->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_colors"><div class="pruchase_report_Product_colors"><span class="ew-table-header-caption"><?php echo $Page->Product_colors->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_colors">
<?php if ($Page->sortUrl($Page->Product_colors) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_colors">
			<span class="ew-table-header-caption"><?php echo $Page->Product_colors->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_colors" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_colors) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_colors->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="image_url"><div class="pruchase_report_image_url"><span class="ew-table-header-caption"><?php echo $Page->image_url->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="image_url">
<?php if ($Page->sortUrl($Page->image_url) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_image_url">
			<span class="ew-table-header-caption"><?php echo $Page->image_url->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_image_url" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->image_url) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->image_url->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="date"><div class="pruchase_report_date"><span class="ew-table-header-caption"><?php echo $Page->date->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="date">
<?php if ($Page->sortUrl($Page->date) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_date">
			<span class="ew-table-header-caption"><?php echo $Page->date->caption() ?></span>
	<?php if (!$DashboardReport) { ?>
			<a class="ew-table-header-popup" title="<?php echo $ReportLanguage->phrase("Filter"); ?>" onclick="ew.showPopup.call(this, event, { id: 'x_date', form: 'fpruchase_reportrpt', name: 'pruchase_report_date', range: false, from: '<?php echo $Page->date->RangeFrom; ?>', to: '<?php echo $Page->date->RangeTo; ?>' });" id="x_date<?php echo $Page->Counts[0][0]; ?>"><span class="icon-filter"></span></a>
	<?php } ?>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_date" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->date) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->date->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Category_idProduct_Category"><div class="pruchase_report_Product_Category_idProduct_Category"><span class="ew-table-header-caption"><?php echo $Page->Product_Category_idProduct_Category->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Category_idProduct_Category">
<?php if ($Page->sortUrl($Page->Product_Category_idProduct_Category) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Category_idProduct_Category">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Category_idProduct_Category->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Category_idProduct_Category" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Category_idProduct_Category) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Category_idProduct_Category->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="idPurchase_Order"><div class="pruchase_report_idPurchase_Order"><span class="ew-table-header-caption"><?php echo $Page->idPurchase_Order->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="idPurchase_Order">
<?php if ($Page->sortUrl($Page->idPurchase_Order) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_idPurchase_Order">
			<span class="ew-table-header-caption"><?php echo $Page->idPurchase_Order->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_idPurchase_Order" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->idPurchase_Order) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->idPurchase_Order->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="pro_id"><div class="pruchase_report_pro_id"><span class="ew-table-header-caption"><?php echo $Page->pro_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="pro_id">
<?php if ($Page->sortUrl($Page->pro_id) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_pro_id">
			<span class="ew-table-header-caption"><?php echo $Page->pro_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_pro_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->pro_id) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->pro_id->caption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->Product_Qty1->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Product_Qty1"><div class="pruchase_report_Product_Qty1"><span class="ew-table-header-caption"><?php echo $Page->Product_Qty1->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Product_Qty1">
<?php if ($Page->sortUrl($Page->Product_Qty1) == "") { ?>
		<div class="ew-table-header-btn pruchase_report_Product_Qty1">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Qty1->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer pruchase_report_Product_Qty1" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Product_Qty1) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->Product_Qty1->caption() ?></span>
			<span class="ew-table-header-sort"><?php if ($Page->Product_Qty1->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($Page->Product_Qty1->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php } ?>
<?php if ($Page->Product_Qty1->Visible) { ?>
		<td data-field="Product_Qty1"<?php echo $Page->Product_Qty1->cellAttributes() ?>>
<span<?php echo $Page->Product_Qty1->viewAttributes() ?>><?php echo $Page->Product_Qty1->getViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "pruchase_report_pager.php" ?>
