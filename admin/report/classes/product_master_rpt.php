...
/**
 * Page class (product_master_rpt)
 */
class product_master_rpt extends product_master_base
{
	...
	// Page object name
	public $PageObjName = 'product_master_rpt';
	public $Token = "";
	...
	public function __construct()
	{
		...
		// Table object (product_master_base)
		if (!isset($GLOBALS["product_master_base"])) {
			$GLOBALS["product_master_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["product_master_base"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'product_master');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fproduct_masterrpt";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fproduct_masterrpt\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fproduct_masterrpt\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fproduct_masterrpt\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
