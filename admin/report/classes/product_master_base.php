...
/**
 * Table class for product_master
 */
class product_master_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'product_master_base';
		...
		// idProduct_Master
		$this->idProduct_Master = new ReportField('product_master_base', 'product_master', 'x_idProduct_Master', 'idProduct_Master', '`idProduct_Master`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Product_Name
		$this->Product_Name = new ReportField('product_master_base', 'product_master', 'x_Product_Name', 'Product_Name', '`Product_Name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product_Name->Sortable = TRUE; // Allow sort
		$this->Product_Name->DateFilter = "";
		$this->fields['Product_Name'] = &$this->Product_Name;

		// Product_Details
		$this->Product_Details = new ReportField('product_master_base', 'product_master', 'x_Product_Details', 'Product_Details', '`Product_Details`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product_Price
		$this->Product_Price = new ReportField('product_master_base', 'product_master', 'x_Product_Price', 'Product_Price', '`Product_Price`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product_Size
		$this->Product_Size = new ReportField('product_master_base', 'product_master', 'x_Product_Size', 'Product_Size', '`Product_Size`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product_Size->Sortable = TRUE; // Allow sort
		$this->Product_Size->DateFilter = "";
		$this->fields['Product_Size'] = &$this->Product_Size;

		// Product_Qty
		$this->Product_Qty = new ReportField('product_master_base', 'product_master', 'x_Product_Qty', 'Product_Qty', '`Product_Qty`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product_colors
		$this->Product_colors = new ReportField('product_master_base', 'product_master', 'x_Product_colors', 'Product_colors', '`Product_colors`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product_colors->Sortable = TRUE; // Allow sort
		$this->Product_colors->DateFilter = "";
		$this->fields['Product_colors'] = &$this->Product_colors;

		// image_url
		$this->image_url = new ReportField('product_master_base', 'product_master', 'x_image_url', 'image_url', '`image_url`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->image_url->Sortable = TRUE; // Allow sort
		$this->image_url->DateFilter = "";
		$this->fields['image_url'] = &$this->image_url;

		// date
		$this->date = new ReportField('product_master_base', 'product_master', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Product_Category_idProduct_Category = new ReportField('product_master_base', 'product_master', 'x_Product_Category_idProduct_Category', 'Product_Category_idProduct_Category', '`Product_Category_idProduct_Category`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`product_master`";
	}
