...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>skumar.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>skumar.ico">
