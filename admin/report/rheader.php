...
<head>
	...
	<?php if (@$ExportType == "" || @$ExportType == "print") { ?>
		<script>
			if (!window.jQuery) getScript("jquery/jquery-3.4.1.min.js");
		</script>
		<script>
	...
	<?php if (@$ExportType == "" || @$ExportType == "print") { ?>
		...
		<?php } ?>
		<script>
			if (window.jQuery && !jQuery.colorbox) getScript("colorbox/jquery.colorbox-min.js");
		</script>
		<script>
			if (window.jQuery && typeof MobileDetect === 'undefined') getScript("phprptjs/mobile-detect.min.js");
		</script>
		<script>
			getScript("phprptjs/clipboard.min.js");
		</script>
		<script>
			getScript("phprptjs/ewp15.js");
		</script>
		<script>
			getScript("phprptjs/ewr12.js");
		</script>
		<script>
			jQuery.extend(ew, {
		...
		<script>
			if (window.jQuery && !window.jQuery.views) getScript("phprptjs/jsrender.min.js");
		</script>
	<?php } ?>
	<?php if (@$ExportType == "" || @$ExportType == "print") { ?>
		<script>
		...
		<script>
			getScript("phprptjs/rusrfn12.js");
		</script>
		<script>
			// Write your client script here, no need to add script tags.
		</script>
	<?php } ?>
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>skumar.ico">
	<link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>skumar.ico">
