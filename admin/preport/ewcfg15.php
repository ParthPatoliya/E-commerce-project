...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'TCI8uWdMXvykj6h3'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phprptcss/project3.css"); // Project stylesheet file name
...
$PROJECT_ID = "{DD726A49-062F-4C52-A75E-F27B4CB41945}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "skumar", "qs" => "`", "qe" => "`");
