...
/**
 * Table class for Purchases Report
 */
class Purchases_Report extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Purchases_Report';
		$this->TableName = 'Purchases Report';
		...
		// Product_Name
		$this->Product_Name = new ReportField('Purchases_Report', 'Purchases Report', 'x_Product_Name', 'Product_Name', '`Product_Name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->Product_Name->Lookup = new ReportLookup('Product_Name', 'Purchases_Report', TRUE, 'Product_Name', ["Product_Name","","",""], [], [], [], [], [], [], '`Product_Name` ASC', '');
		$this->Product_Name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['Product_Name'] = &$this->Product_Name;

		// Product_Details
		$this->Product_Details = new ReportField('Purchases_Report', 'Purchases Report', 'x_Product_Details', 'Product_Details', '`Product_Details`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product_Qty
		$this->Product_Qty = new ReportField('Purchases_Report', 'Purchases Report', 'x_Product_Qty', 'Product_Qty', '`Product_Qty`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product_Price
		$this->Product_Price = new ReportField('Purchases_Report', 'Purchases Report', 'x_Product_Price', 'Product_Price', '`Product_Price`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product_Size
		$this->Product_Size = new ReportField('Purchases_Report', 'Purchases Report', 'x_Product_Size', 'Product_Size', '`Product_Size`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product_Size->Sortable = TRUE; // Allow sort
		$this->Product_Size->DateFilter = "";
		$this->fields['Product_Size'] = &$this->Product_Size;

		// Product_colors
		$this->Product_colors = new ReportField('Purchases_Report', 'Purchases Report', 'x_Product_colors', 'Product_colors', '`Product_colors`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product_colors->Sortable = TRUE; // Allow sort
		$this->Product_colors->DateFilter = "";
		$this->fields['Product_colors'] = &$this->Product_colors;

		// Category_Name
		$this->Category_Name = new ReportField('Purchases_Report', 'Purchases Report', 'x_Category_Name', 'Category_Name', '`Category_Name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->Category_Name->Lookup = new ReportLookup('Category_Name', 'Purchases_Report', TRUE, 'Category_Name', ["Category_Name","","",""], [], [], [], [], [], [], '`Category_Name` ASC', '');
		$this->Category_Name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['Category_Name'] = &$this->Category_Name;

		// date
		$this->date = new ReportField('Purchases_Report', 'Purchases Report', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->date->Lookup = new ReportLookup('date', 'Purchases_Report', TRUE, 'date', ["date","","",""], [], [], [], [], [], [], '`date` ASC', '');
